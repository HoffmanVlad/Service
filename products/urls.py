...
from .views import ProductListView, UserCreateView, LoginingView, Logout, ProductDetailView, NewProductView, \
    ProfileUser, NewUserView, EditProductView, ProfileUserCompany, ProfileUserEdit, NewAutoView, AutoCompany
...
urlpatterns = [
    ...
    path('products/add/id=<int:id>', NewUserView.as_view(), name='newuserview'),
    path('products/auto/', AutoCompany.as_view(), name='newautoview'),
    path('products/new', NewProductView.as_view(), name='new_product'),
    path('products/add/auto', NewAutoView.as_view(), name='new_auto'),
    path('products/user/id=<int:pk>', ProfileUserCompany.as_view(), name='newuser'),
    path('profile/', ProfileUser.as_view(), name='profile'),
    path('profile/edit/id=<int:pk>', ProfileUserEdit.as_view(), name='profile_edit'),
